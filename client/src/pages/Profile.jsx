  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <button
        ...
        className="bg-green-700 text-white rounded-lg p-3 uppercase text-center w-full hover:opacity-95 disabled:opacity-80"
      >
        Show Listings
      </button>
      <p className="text-red-700 mt-5">
        {showListingError ? "Error showng listings" : ""}
      </p>
